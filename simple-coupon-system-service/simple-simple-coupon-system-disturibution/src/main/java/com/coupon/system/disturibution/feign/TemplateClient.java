...
import com.coupon.system.disturibution.feign.hystrix.TemplateClientHystrix;
...
@FeignClient(value = "simple-coupon-system-template",fallback = TemplateClientHystrix.class)
